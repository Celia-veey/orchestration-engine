...
Before exploring, follow ../grill-with-docs/DOMAIN-AWARENESS.md — read **CONTEXT.md** and relevant ADRs first.
...
- **Consistency**: Use the same terminology throughout all suggestions
- **Domain-aware**: Let the project's domain model guide naming and structure
- **ADR-respect**: Don't re-litigate decisions already recorded in ADRs
- **User-driven**: Present candidates first, then explore the chosen direction together
